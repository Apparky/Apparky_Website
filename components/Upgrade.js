...
const Explore = () => {
    ...
    >
      ...
      animate={control}
      >
        <motion.h4 layout="position" className='text-white lg:text-9xl  text-4xl font-semibold'>Upgrade</motion.h4>
        {showCard && (
          ...
          <div className="shadow-lg flex flex-wrap w-full lg:w-4/5 mx-auto">
            ...
            {/* ./Card image */}
            {/* Card body */}
            <div className="bg-gradient-to-r from-[#6e6e6dff] w-full md:w-2/3">
              ...
              <div className="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
                ...
                <div className="bg- lg:h-full p-6 -mt-6 md:mt-0 relative mb-4 md:mb-0 flex flex-wrap md:flex-wrap items-center">
                  ...
                  <div className="w-full lg:w-3/5 lg:px-3">
                    ...
                    We believe that if we put our efforts it will be equal to your success. This will always built the enthusiasm to be our partners. We are repeatedly raising and improving ourselves to understand you better in every possible ways. Every single time you connect us we improve ourselves one step forward and the same applies to your business as well. This is the core focus of Apparky.
                    </p>
                  </div>
                  {/* ./Card description */}
